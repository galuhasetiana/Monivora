...
<style>
    ...
    .form-group select:focus { border-color:#B87A3A; }
    ...
    <form method="POST" action="{{ route('transaksi.store') }}">
        ...
        <div class="toggle-wrap">
            <button type="button" id="btnPemasukan"
                class="toggle-btn {{ old('jenis', 'Pengeluaran') === 'Pemasukan' ? 'active' : '' }}">
                Pemasukan
            </button>
            <button type="button" id="btnPengeluaran"
                class="toggle-btn {{ old('jenis', 'Pengeluaran') === 'Pengeluaran' ? 'active' : '' }}">
                Pengeluaran
            </button>
        </div>
        <input type="hidden" name="jenis" id="jenisInput"
               value="{{ old('jenis', 'Pengeluaran') }}">
        ...
        <div class="form-group">
            ...
            <input type="text" name="keterangan"
                   ...
                   placeholder="Contoh: Makan siang di warteg" required>
